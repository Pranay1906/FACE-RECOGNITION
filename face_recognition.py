...
<html lang="en-us"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./face_recognition_files/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="./face_recognition_files/jquery.typeahead.min.css" type="text/css">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    
    <link rel="stylesheet" href="./face_recognition_files/style.min.css" type="text/css">
    
    <link rel="stylesheet" href="./face_recognition_files/custom.css" type="text/css">
    <script src="./face_recognition_files/promise.min.js.download" type="text/javascript" charset="utf-8"></script>
    <script src="./face_recognition_files/react.production.min.js.download" type="text/javascript"></script>
    <script src="./face_recognition_files/react-dom.production.min.js.download" type="text/javascript"></script>
    <script src="./face_recognition_files/index.js.download" type="text/javascript"></script>
    <script src="./face_recognition_files/require.js.download" type="text/javascript" charset="utf-8"></script>
    <script>
      require.config({
...
<script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="services/contents" src="./face_recognition_files/contents.js.download"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="custom/custom" src="./face_recognition_files/custom.js.download"></script></head>
...
<div id="header" role="navigation" aria-label="Top Menu" style="display: block;">
  ...
  <div id="ipython_notebook" class="nav navbar-brand"><a href="http://localhost:8888/tree?token=7a12f2aadc0e29eec084f9e6081528d433a1b0cda5ca324f" title="dashboard">
      <img src="./face_recognition_files/logo.png" alt="Jupyter Notebook">
  </a></div>
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseTwo" class=" collapse in">
                <div class="panel-body">
                  ...
                  <div class="list_item row"><div class="col-md-12"><i class="item_icon running_notebook_icon icon-fixed-width"></i><a class="item_link" href="http://localhost:8888/notebooks/face_data.ipynb" target="_blank"><span class="item_name">face_data.ipynb</span></a><div class="pull-right"><div class="item_buttons pull-left"><div class="kernel-name">Python 3</div><button class="btn btn-warning btn-xs">Shutdown</button></div><div class="pull-right"><span class="item_modified pull-left" title="2020-05-19 14:04">seconds ago</span><span class="file_size pull-right">&nbsp;</span></div></div></div></div><div class="list_item row"><div class="col-md-12"><i class="item_icon running_notebook_icon icon-fixed-width"></i><a class="item_link" href="http://localhost:8888/notebooks/face_recognition.ipynb" target="_blank"><span class="item_name">face_recognition.ipynb</span></a><div class="pull-right"><div class="item_buttons pull-left"><div class="kernel-name">Python 3</div><button class="btn btn-warning btn-xs">Shutdown</button></div><div class="pull-right"><span class="item_modified pull-left" title="2020-05-19 14:04">seconds ago</span><span class="file_size pull-right">&nbsp;</span></div></div></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<script src="./face_recognition_files/main.min.js.download" type="text/javascript" charset="utf-8"></script>
